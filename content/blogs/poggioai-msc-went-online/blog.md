...
If you want the full scope, architecture, and limits, start with the [technical report](https://poggioai.github.io/papers/poggioai-msc-v0.pdf). If you want the project homepage and future updates, visit [PoggioAI.github.io](https://poggioai.github.io/). If you want to try it, the fastest path is the [GitHub repository](https://github.com/PoggioAI/PoggioAI_MSc/tree/MSc_Prod).
